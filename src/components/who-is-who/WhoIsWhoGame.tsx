...
export default function WhoIsWhoGame() {
    ...
    const [boardCharacters, setBoardCharacters] = useState(() => shuffleArray(allCharacters).slice(0, 24));
    ...
    const resetGame = () => {
        const newBoardChars = shuffleArray(allCharacters).slice(0, 24);
    ...
    return (
        <div className="w-full max-w-4xl mx-auto flex flex-col items-center">
            ...
            <div className="w-full grid grid-cols-4 sm:grid-cols-5 md:grid-cols-6 lg:grid-cols-8 gap-2 p-2">
